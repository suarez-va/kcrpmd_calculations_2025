...
_sys_2_method_2_fix_y = sorted([k for k in calc_dirs if k.startswith("_sys_2_method_2_fix_y")], key=lambda s: float(s.split('_')[8]))
_sys_2_method_2_fix_s = sorted([k for k in calc_dirs if k.startswith("_sys_2_method_2_fix_s")], key=lambda s: float(s.split('_')[8]))
...
with open("../" + _sys_2_method_1[0] + "/_control_params.txt") as f:
...
for i in range(3):
    kold_arr[i] = np.loadtxt("../" + _sys_2_method_2_fix_y[i] + "/tst_data/ktsty.txt")
    kold_se_arr[i] = kold_arr[i] * np.loadtxt("../" + _sys_2_method_2_fix_y[i] + "/kappa_data/kappa_se.txt")[-1]
    kold_arr[i] *= np.loadtxt("../" + _sys_2_method_2_fix_y[i] + "/kappa_data/kappa_avg.txt")[-1]
...
for i in range(3,9):
    kold_arr[i] = np.loadtxt("../" + _sys_2_method_2_fix_s[i] + "/tst_data/ktsts.txt")
    kold_se_arr[i] = kold_arr[i] * np.loadtxt("../" + _sys_2_method_2_fix_s[i] + "/kappa_data/kappa_se.txt")[-1]
    kold_arr[i] *= np.loadtxt("../" + _sys_2_method_2_fix_s[i] + "/kappa_data/kappa_avg.txt")[-1]
...
#for i in range(9):
#    kold_arr[i] = np.loadtxt("../" + _sys_2_method_3_fix_y[i] + "/tst_data/ktsty.txt")
#    #kold_arr[i] *= np.loadtxt("../" + _sys_2_method_3_fix_y[i] + "/kappa_data/kappa_avg.txt")[-1]
#    kold_se_arr[i] = 0*kold_arr[i] * np.loadtxt("../" + _sys_2_method_3_fix_y[i] + "/kappa_data/kappa_se.txt")[-1]
#    knew_arr[i] = np.loadtxt("../" + _sys_2_method_3_fix_s[i] + "/tst_data/ktsts.txt")
#    #knew_arr[i] *= np.loadtxt("../" + _sys_2_method_3_fix_s[i] + "/kappa_data/kappa_avg.txt")[-1]
#    knew_se_arr[i] =0* knew_arr[i] * np.loadtxt("../" + _sys_2_method_3_fix_s[i] + "/kappa_data/kappa_se.txt")[-1]
