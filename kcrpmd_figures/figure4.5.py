...
_sys_1_method_1 = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_1")], key=lambda s: float(s.split('_')[10]))
_sys_1_method_2_fix_y = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_2_a_0.1_fix_y")], key=lambda s: float(s.split('_')[12]))
_sys_1_method_2_a_1_fix_y = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_2") and "_a_0.1" not in k and "_fix_y" in k], key=lambda s: float(s.split('_')[12]))
...
_sys_1_method_2_fix_s = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_2_a_0.1_fix_s")], key=lambda s: float(s.split('_')[12]))
_sys_1_method_2_a_1_fix_s = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_2") and "_a_0.1" not in k and "_fix_s" in k], key=lambda s: float(s.split('_')[12]))
...
_sys_1_method_3_fix_y = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_3_fix_y")], key=lambda s: float(s.split('_')[10]))
_sys_1_method_3_fix_s = sorted([k for k in calc_dirs if k.startswith("_sys_1_gam_32.0_method_3_fix_s")], key=lambda s: float(s.split('_')[10]))
...
K0_arr = np.array([key.split('_')[10] for key in _sys_1_method_1], dtype=float)[1:]
