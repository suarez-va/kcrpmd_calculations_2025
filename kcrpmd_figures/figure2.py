...
ax1.set_ylim(-beta*0.0015,beta*0.0028) #ax1.set_ylim(-0.002,0.03)
ax2.set_ylim(-beta*0.0015,beta*0.0028) #ax2.set_ylim(-0.002,0.03)
ax1.set_yticks([-1, 0, 1, 2])
ax2.set_xticks([-4, -2, 0, 2, 4])
ax2.set_yticks([-1, 0, 1, 2])
ax2.set_xlabel(r"$s$")
ax1.set_ylabel(r"$\beta\Delta F(s)$", labelpad=1)
ax2.set_ylabel(r"$\beta\Delta F(s)$", labelpad=1)
